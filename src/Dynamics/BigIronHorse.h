...
#ifndef PROJECT_BIGIRONHORSE_H
#define PROJECT_BIGIRONHORSE_H
 ...
 */
template <typename T>
Quadruped<T> buildBigIronHorse() {
  Quadruped<T> cheetah;
  cheetah._robotType = RobotType::MINI_CHEETAH;

  cheetah._bodyMass = 70;
  cheetah._bodyLength = 0.73 * 2;
  ...
  cheetah._abadLinkLength = 0.205;
  cheetah._hipLinkLength = 0.32;
  cheetah._kneeLinkY_offset = 0.0;
  cheetah._kneeLinkLength = 0.4;
  cheetah._maxLegLength = 0.925;
  ...
  //cheetah._abadLocation = Vec3<T>(cheetah._bodyLength, cheetah._bodyWidth, -cheetah._bodyHeight) * 0.5;
  cheetah._abadLocation = Vec3<T>(cheetah._bodyLength, cheetah._bodyWidth, -0.44) * 0.5;
