...
get_last_vel = [0] * 3
jointName = ['Joint_HL2','Joint_HF2','Joint_KF2',\
        'Joint_HL1','Joint_HF1','Joint_KF1',\
            'Joint_HL4','Joint_HF4','Joint_KF4',\
                'Joint_HL3','Joint_HF3','Joint_KF3']
...
def get_data_from_sim():
    ...
    leg_data[1] = leg_data[1] + math.pi/3.0;
    leg_data[4] = leg_data[4] + math.pi/3.0;
    leg_data[7] = leg_data[7] - math.pi/3.0;
    leg_data[10] = leg_data[10] - math.pi/3.0;
