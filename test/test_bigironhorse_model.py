...
init_new_pos = [0.0, -1.13, 1.6, 0.0, -1.13, 1.6, 0.0, 1.13, -1.6, 0.0, 1.13, -1.6,
...
robot_start_pos = [0, 0, 0.8]
boxId = p.loadURDF("./models/big_iron_horse/big_iron_horse_simple.urdf", robot_start_pos,
                       useFixedBase=False)
